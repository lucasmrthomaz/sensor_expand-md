...
var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		this.tracker = new AR.ClientTracker("assets/omo4.wtc", {
		...
		*/
		...
		//var logoMercadata = new AR.ImageResource("assets/samurai-eyes.png");


		/** Parte do codigo responsavel por adicionar uma imagem na cena
		logo abaixo do MARCADOR */
		...
		var phonegap_text2 = new AR.ImageResource("assets/mercadata.jpg");
		var overlayTwo = new AR.ImageDrawable(phonegap_text2, 0.3, {
			offsetX: 0,
			offsetY: -0.10
		});
		...
		*/
		var pageOne = new AR.Trackable2DObject(this.tracker, "*", {
			drawables: {
				// Aqui voce declara os elementos que vao ser trakeados
				cam: [samurai_eyes_animate, overlayOne, overlayTwo] 
			}
		});
	},
